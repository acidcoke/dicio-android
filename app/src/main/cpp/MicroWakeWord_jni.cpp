...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* /*reserved*/) {
    ...
    // Vendored from home-assistant/android microwakeword module.
    // Repackaged to org.stypox.dicio.io.wake.mww — keep this FQN in sync with MicroWakeWord.kt.
    jclass clazz = env->FindClass("org/stypox/dicio/io/wake/mww/MicroWakeWord");
    if (clazz == nullptr) {
