 ...
 * [SpeechStream], pushes them to [eventListener], and handles the listening state via
 * [VoskInputDevice].
 *
...
internal class VoskListener(
    ...
    private val speechStream: SpeechStream,
) : RecognitionListener {
    ...
    override fun onResult(s: String) {
        ...
        val inputs = try {
            ...
            voskInputDevice.stopListening(speechStream, eventListener, false)
            return
        }
    ...
    override fun onTimeout() {
        ...
        voskInputDevice.stopListening(speechStream, eventListener, true)
    }
